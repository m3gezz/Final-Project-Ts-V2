...
export default function Navbar({
  ...
  return (
    <header className="relative sticky top-0 z-50 bg-white px-4 pt-3 pb-0 backdrop-blur-sm sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex h-[64px] max-w-7xl items-center justify-between rounded-[28px] border border-white/40 bg-white/75 px-4 shadow-[0_10px_40px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-all duration-300 sm:px-5">
        <Link
          to="/welcome"
          className="flex items-center gap-2 text-brand-dark transition-opacity hover:opacity-90"
        >
          <img src="/colab-logo-gradient.svg" alt="CoLab" className="h-8 w-auto sm:h-9" />
        </Link>
        ...
        <div className="hidden items-center gap-2.5 lg:flex">
          <Link
            to="/sign-in"
            className="rounded-full border border-white/50 bg-white/85 px-[18px] py-2.5 text-sm font-medium text-slate-700 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-primary hover:text-brand-primary"
          >
            Se connecter
          </Link>
          <Link
            to="/sign-up"
            className="rounded-full bg-brand-dark px-[18px] py-2.5 text-sm font-medium text-white shadow-lg shadow-blue-200 transition-all duration-300 hover:-translate-y-0.5 hover:bg-brand-primary"
          >
      ...
      {mobileOpen ? (
        <div className="mx-auto mt-3 max-w-6xl rounded-[1.5rem] border border-white/40 bg-white/90 shadow-xl backdrop-blur-[16px] lg:hidden">
