        ...
        <section className="px-4 pt-16 pb-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-brand-muted">
              ...
              d'acceder a une education de qualite, peu importe d'ou l'on
              vient. Fondee en 2021 par une equipe de passionnes d'education et
              de technologie, CoLab rassemble aujourd'hui plus de 100 000
        ...
        <section className="px-4 pb-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl rounded-[2rem] bg-white p-10 text-center shadow-sm ring-1 ring-slate-100">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg leading-8 text-brand-muted">
              Que vous soyez apprenant, formateur ou entreprise, CoLab a
