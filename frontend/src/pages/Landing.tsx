...
import studentImage from "../assets/christian-velitchkov-mXz64B8-3h0-unsplash.jpg";
...
const AvatarRow = memo(({ seeds }: { seeds: readonly number[] }) => {
  return (
    <div className="flex items-center -space-x-2" role="group" aria-label="Membres de l'équipe">
      {seeds.map((seed) => (
        <img
          key={seed}
...
function FeatureCard({ feature, index }: { feature: FeatureType; index: number }) {
  ...
  return (
    ...
    >
      <div className={`inline-flex h-12 w-12 items-center justify-center rounded-2xl ${feature.iconClass}`}>
...
function TestimonialCard({
  ...
  return (
    <motion.article
      ...
      viewport={{ once: true, margin: "-50px" }}
      transition={{ duration: 0.5, delay: index * 0.1, ease: [0.25, 0.1, 0.25, 1] }}
      animate={active ? { scale: 1.02, transition: { duration: 0.3 } } : { scale: 1 }}
...
function HeroImageComposition() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[640px] pt-8 lg:h-[640px]">
      ...
      <motion.div
        animate={{ y: [0, -6, 0] }}
        transition={{ repeat: Infinity, duration: 5, ease: "easeInOut", repeatType: "loop" }}
      ...
      <motion.div
        animate={{ y: [0, -6, 0] }}
        transition={{ repeat: Infinity, duration: 5.5, ease: "easeInOut", delay: 0.2, repeatType: "loop" }}
      ...
      >
        ...
        <p className="mt-1.5 text-[2.45rem] font-bold leading-none text-slate-900">450+</p>
      ...
      <motion.div
        animate={{ y: [0, -5, 0] }}
        transition={{ repeat: Infinity, duration: 6, ease: "easeInOut", delay: 0.35, repeatType: "loop" }}
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-xs font-semibold text-slate-500">Projet collaboratif</p>
      ...
      <motion.div
        animate={{ y: [0, -5, 0] }}
        transition={{ repeat: Infinity, duration: 5.8, ease: "easeInOut", delay: 0.5, repeatType: "loop" }}
        ...
        <section className="relative px-4 pt-2 pb-10 sm:px-6 lg:px-8 lg:pt-3 lg:pb-12">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:gap-8">
            ...
            >
              ...
              >
                Fini les fils de discussion perdus, les fichiers dispersés et les réunions inutiles. CoLab centralise vos espaces de travail, vos tâches et vos échanges pour que votre équipe se concentre sur ce qui compte : le projet.
              </motion.p>
              ...
              >
                ...
                <p className="max-w-sm text-sm leading-6 text-brand-muted">
                  Déjà 100 000+ étudiants qui coordonnent leurs projets d'équipe sur CoLab
                </p>
              </motion.div>
            </motion.div>
        ...
        >
          <div className="mx-auto max-w-7xl">
            <div className="text-center">
              ...
              >
                Une plateforme conçue pour que les équipes étudiantes avancent sans friction
              </motion.h2>
            </div>
            ...
            <div className="mt-6 flex items-center justify-center gap-2.5">
              {testimonials.map((_, idx) => (
                <motion.button
                  ...
                  animate={activeTestimonial === idx ? { scale: [1, 1.2, 1] } : {}}
                  transition={{ duration: 0.5 }}
                  className={`h-2.5 w-2.5 rounded-full transition-all duration-300 ${
                    activeTestimonial === idx ? "bg-brand-primary w-6" : "bg-slate-300"
                  }`}
                />
              ))}
            </div>
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2rem] bg-gradient-to-br from-brand-primary to-brand-accent lg:grid-cols-2">
            <div className="p-8 sm:p-9 lg:p-10">
              ...
              >
                Rejoignez des milliers d'équipes étudiantes qui livrent leurs projets à temps, sans le chaos habituel.
              </motion.p>
              <motion.div 
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="mx-auto flex max-w-5xl flex-col gap-5 rounded-[2rem] border border-slate-100 bg-white p-5 shadow-sm sm:flex-row sm:items-center sm:px-7 sm:py-5">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1.5 text-sm leading-6 text-brand-muted">
                Nouvelles fonctionnalités, conseils de collaboration et ressources académiques — directement dans votre boîte mail, une fois par semaine.
              </p>
            </div>
            <form
              onSubmit={(event) => {
