...
<html lang="en">
  ...
  <body style="background:#f4f4f4;padding:20px;font-family:Arial,sans-serif;">
    ...
    >
      ...
      <h3 style="margin-bottom:10px; color:#111;">Reset you password</h3>

      <p style="color:#555; font-size:14px;">Use the reset code below to confirm your email address, And reset your password</p>
